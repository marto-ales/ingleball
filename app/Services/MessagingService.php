...
class MessagingService
{
     ...
     *
     * @param  Collection<int, MatchTeam>  $teamA
     * @param  Collection<int, MatchTeam>  $teamB
     * @param  Collection<int, MatchEntry>  $entriesGoing
     * @param  Collection<int, MatchEntry>  $entriesSubstitute
     */
